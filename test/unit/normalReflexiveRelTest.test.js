...
type MainType {
  code: String
  outProp: [ReflexiveRelationshipType]
  inProp: [ReflexiveRelationshipType]
}
...
type Query {
  ...
  const expectedSchema = /* GraphQL */ `
    ...
    input _MainTypeFilter {
      ...
      outProp: _ReflexiveRelationshipTypeDirectionsFilter
      outProp_not: _ReflexiveRelationshipTypeDirectionsFilter
      outProp_in: [_ReflexiveRelationshipTypeDirectionsFilter!]
      outProp_not_in: [_ReflexiveRelationshipTypeDirectionsFilter!]
      outProp_some: _ReflexiveRelationshipTypeDirectionsFilter
      outProp_none: _ReflexiveRelationshipTypeDirectionsFilter
      outProp_single: _ReflexiveRelationshipTypeDirectionsFilter
      outProp_every: _ReflexiveRelationshipTypeDirectionsFilter
      inProp: _ReflexiveRelationshipTypeDirectionsFilter
      inProp_not: _ReflexiveRelationshipTypeDirectionsFilter
      inProp_in: [_ReflexiveRelationshipTypeDirectionsFilter!]
      inProp_not_in: [_ReflexiveRelationshipTypeDirectionsFilter!]
      inProp_some: _ReflexiveRelationshipTypeDirectionsFilter
      inProp_none: _ReflexiveRelationshipTypeDirectionsFilter
      inProp_single: _ReflexiveRelationshipTypeDirectionsFilter
      inProp_every: _ReflexiveRelationshipTypeDirectionsFilter
    }

    input _ReflexiveRelationshipTypeDirectionsFilter {
      from: _ReflexiveRelationshipTypeFilter
      to: _ReflexiveRelationshipTypeFilter
    }

    input _ReflexiveRelationshipTypeFilter {
      AND: [_ReflexiveRelationshipTypeFilter!]
      OR: [_ReflexiveRelationshipTypeFilter!]
    ...
    type _MainTypeOutPropDirections
      ...
      from(filter: _ReflexiveRelationshipTypeFilter): [_MainTypeOutProp]
      to(filter: _ReflexiveRelationshipTypeFilter): [_MainTypeOutProp]
    }

    type _MainTypeInPropDirections
      @relation(name: "REFLEXIVE_REL", from: "MainType", to: "MainType") {
      from(filter: _ReflexiveRelationshipTypeFilter): [_MainTypeInProp]
      to(filter: _ReflexiveRelationshipTypeFilter): [_MainTypeInProp]
    }
